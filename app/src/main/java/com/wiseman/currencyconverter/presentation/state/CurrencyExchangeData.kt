 ...
 *
 * @property sellingCurrency The currency being sold. Defaults to EUR with
 *     amount 0.
 * @property buyingCurrency The currency being bought. Defaults to USD with
 *     amount 0.
 * @property commission The commission applied to the exchange. Defaults
 *     to 0.
 * @property totalAmount The total amount of the transaction in the selling
...
data class CurrencyExchangeData(
    ...
    val formattedCommission: String
        get() = "${sellingCurrency.code} ${commission.roundToTwoDecimalPlaces()}"

    val formattedTotal: String
        get() = "${sellingCurrency.code} ${totalAmount.roundToTwoDecimalPlaces()}"
